...
namespace NetCore
{
    ...
    public static class ServerExtensions
    {
        ...
        /// </param>
        public static OperationResultTask Start(this Server server, ushort localPort)
        {
        ...
        /// Port to bind all transports to. Transports that rely on UID (such as SteamNetworking) might use another port instead.
        /// </param>
        public static OperationResultTask Start(this Server server, IPAddress localAddress, ushort localPort)
        {
        ...
        public static OperationResultTask Start(this Server server, IPEndPoint localEndPoint)
        {
        ...
        public static OperationResultTask Connect(this Server server, IPAddress remoteAddress, ushort remotePort)
        {
        ...
        public static OperationResultTask Connect(this Server server, IPEndPoint remoteEndPoint)
        {
