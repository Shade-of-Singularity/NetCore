...
namespace NetCore.Transports.Special
{
    ...
    public static partial class TCPUDPTransportExtensions
    {
        ...
        public static void RegisterTransport(this NetworkMember member, TCPUDPTransport transport)
        {
        ...
        public static bool RemoveTransport(this NetworkMember member, TCPUDPTransport transport)
        {
            bool result = false;
        ...
        /// <param name="member"><see cref="NetworkMember"/> to work with.</param>
        /// <param name="transport"><see cref="TCPUDPTransport"/> to remove.</param>
        public static bool RemoveTransport(this NetworkMember member, [NotNullWhen(true)] out TCPUDPTransport? transport)
        {
            transport = default;
