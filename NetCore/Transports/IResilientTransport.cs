...
namespace NetCore.Transports
{
    ...
    public interface IResilientTransport : ITransport
    {
        ...
        public void SendResilient(ReadOnlySpan<byte> datagram, in Header header, in Flags flags);
        /// <summary>
        ...
        public void SendResilientExcluding(ReadOnlySpan<byte> datagram, in Header header, in Flags flags, ConnectionID toExclude);
        /// <summary>
        ...
        public void SendResilientTo(ReadOnlySpan<byte> datagram, in Header header, in Flags flags, ConnectionID target);
        /// <summary>
        ...
        public void HandleResilient(ReadOnlySpan<byte> datagram, in Header header, in Flags flags, ConnectionID source);
        ...
        public void SendResilientTo(ReadOnlySpan<byte> datagram, in Header header, in Flags flags, ConnectionArgs args);
        /// <summary>
        /// Handles raw <paramref name="datagram"/> of a reliable message.
        /// </summary>
        /// <param name="datagram">Datagram from a remote connection.</param>
        ...
        public void HandleResilient(ReadOnlySpan<byte> datagram, in Header header, in Flags flags, ConnectionArgs source);
    }
}
