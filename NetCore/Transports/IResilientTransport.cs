...
namespace NetCore.Transports
{
    ...
    public interface IResilientTransport : ITransport
    {
        ...
        public void SendResilient(in Header header, ReadOnlySpan<byte> datagram, in Flags flags);
        /// <summary>
        ...
        public void SendResilientExcluding(in Header header, ReadOnlySpan<byte> datagram, in Flags flags, ConnectionID toExclude);
        /// <summary>
        ...
        public void SendResilientTo(in Header header, ReadOnlySpan<byte> datagram, in Flags flags, ConnectionID target);
        /// <summary>
        ...
        public void HandleResilient(in Header header, ReadOnlySpan<byte> datagram, in Flags flags, ConnectionID source);
        ...
        public void SendResilientTo(in Header header, ReadOnlySpan<byte> datagram, in Flags flags, ConnectionArgs args);
        /// <summary>
        /// Handles raw <paramref name="datagram"/> of a reliable message.
        /// </summary>
        /// <param name="header">Header of the message.</param>
        ...
        public void HandleResilient(in Header header, ReadOnlySpan<byte> datagram, in Flags flags, ConnectionArgs source);
    }
}
