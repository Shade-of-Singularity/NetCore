...
namespace NetCore
{
    ...
    public static partial class SendNetworkMessagingExtensions
    {
        ...
        /// </summary>
        /// <seealso cref="ISendNetworkMessaging.SendUnreliable(in ReadOnlySpan{byte}, ref Header, ref Flags)"/>
        /// <seealso cref="ISendNetworkMessaging.SendReliable(in ReadOnlySpan{byte}, ref Header, ref Flags)"/>
        /// <seealso cref="ISendNetworkMessaging.SendSequential(in ReadOnlySpan{byte}, ref Header, ref Flags)"/>
        /// <seealso cref="ISendNetworkMessaging.SendResilient(in ReadOnlySpan{byte}, ref Header, ref Flags)"/>
        ...
        public static void Send(this ISendNetworkMessaging target, SendingMode mode, in ReadOnlySpan<byte> datagram, ref Header header, ref Flags flags)
        {
            switch (mode)
            {
        ...
        /// .
        /// ===     ===     ===     ===    ===  == =  -                        -  = ==  ===    ===     ===     ===     ===]]>
        /// <inheritdoc cref="Send(ISendNetworkMessaging, SendingMode, in ReadOnlySpan{byte}, ref Header, ref Flags)"/>
        public static void Send(this ISendNetworkMessaging target, SendingMode mode, in ReadOnlySpan<byte> datagram)
        {
        ...
        /// <inheritdoc cref="Send(ISendNetworkMessaging, SendingMode, in ReadOnlySpan{byte}, ref Header, ref Flags)"/>
        public static void Send(this ISendNetworkMessaging target, SendingMode mode, in ReadOnlySpan<byte> datagram, ref Header header)
        {
            Flags flags = Flags.Get();
            target.Send(mode, datagram, ref header, ref flags);
        }
        ...
        /// <inheritdoc cref="Send(ISendNetworkMessaging, SendingMode, in ReadOnlySpan{byte}, ref Header, ref Flags)"/>
        public static void Send(this ISendNetworkMessaging target, SendingMode mode, in ReadOnlySpan<byte> datagram, ref Flags flags)
        {
            Header header = Header.Get();
            target.Send(mode, datagram, ref header, ref flags);
        }
        ...
        public static void Send(this ISendNetworkMessaging target, SendingMode mode, in ReadOnlySpan<byte> datagram, HeaderConstructor? headerSetup, FlagsConstructor? flagsSetup = null)
        {
            Header header = Header.Get();
